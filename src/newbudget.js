...
export default class NewBudget extends Component {
  ...
  render() {
    //Getting rid of this?  Wanted this to be one page?  Could not
    //get form, update, accordion, number display all working together
      ...
      <div>
        <form className="main-input">
          ...
          <div>
            ...
            <br />
            <span>
              Surplus/(Deficit) {numFormat(incomeObj.amount - totalExp)}
            </span>
          </div>
        </form>
        <br />
